    ...
    public function index() {
      ...
      public function new() {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $clien->setDuracion(htmlentities($_POST['duracion']));
            $clien->setModalidad(htmlentities($_POST['moda']));
    ...
    public function view_edit(){
     ...
     public function edit(){
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $servicio->setDuracion(htmlentities($_POST['duracion']));
            $servicio->setModalidad(htmlentities($_POST['moda']));
